...
if( ! class_exists( 'Showcase_SanPham_Images' ) ) {
    class Showcase_SanPham_Images {
       ...
       */
       ...
       // Image actions
       add_action( 'san-pham_add_form_fields', array( $this, 'add_category_image' ), 10, 2 );
       add_action( 'created_san-pham', array( $this, 'save_category_image' ), 10, 2 );
       add_action( 'san-pham_edit_form_fields', array( $this, 'update_category_image' ), 10, 2 );
       add_action( 'edited_san-pham', array( $this, 'updated_category_image' ), 10, 2 );
       add_action( 'admin_enqueue_scripts', array( $this, 'load_media' ) );
       add_action( 'admin_footer', array( $this, 'add_script' ) );
     }
  
     public function load_media() {
       if( ! isset( $_GET['taxonomy'] ) || $_GET['taxonomy'] != 'san-pham' ) {
         return;
       }
       wp_enqueue_media();
     }
  ...
  $Showcase_SanPham_Images = new Showcase_SanPham_Images();
  $Showcase_SanPham_Images->init(); 
