...
if( ! class_exists( 'Showcase_PhanLoai_Images' ) ) {
    class Showcase_PhanLoai_Images {
       ...
       */
       ...
       // Image actions
       add_action( 'phan-loai_add_form_fields', array( $this, 'add_category_image' ), 10, 2 );
       add_action( 'created_phan-loai', array( $this, 'save_category_image' ), 10, 2 );
       add_action( 'phan-loai_edit_form_fields', array( $this, 'update_category_image' ), 10, 2 );
       add_action( 'edited_phan-loai', array( $this, 'updated_category_image' ), 10, 2 );
       add_action( 'admin_enqueue_scripts', array( $this, 'load_media' ) );
       add_action( 'admin_footer', array( $this, 'add_script' ) );
     }
  
     public function load_media() {
       if( ! isset( $_GET['taxonomy'] ) || $_GET['taxonomy'] != 'phan-loai' ) {
         return;
       }
       wp_enqueue_media();
     }
  ...
  $Showcase_PhanLoai_Images = new Showcase_PhanLoai_Images();
  $Showcase_PhanLoai_Images->init(); 
