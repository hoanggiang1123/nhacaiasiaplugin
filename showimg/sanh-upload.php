...
if( ! class_exists( 'Showcase_Sanh_Images' ) ) {
    class Showcase_Sanh_Images {
       ...
       */
       ...
       // Image actions
       add_action( 'cac-sanh_add_form_fields', array( $this, 'add_category_image' ), 10, 2 );
       add_action( 'created_cac-sanh', array( $this, 'save_category_image' ), 10, 2 );
       add_action( 'cac-sanh_edit_form_fields', array( $this, 'update_category_image' ), 10, 2 );
       add_action( 'edited_cac-sanh', array( $this, 'updated_category_image' ), 10, 2 );
       add_action( 'admin_enqueue_scripts', array( $this, 'load_media' ) );
       add_action( 'admin_footer', array( $this, 'add_script' ) );
     }
  
     public function load_media() {
       if( ! isset( $_GET['taxonomy'] ) || $_GET['taxonomy'] != 'cac-sanh' ) {
         return;
       }
       wp_enqueue_media();
     }
  ...
  $Show_Sanh_Images = new Showcase_Sanh_Images();
  $Show_Sanh_Images->init(); 
